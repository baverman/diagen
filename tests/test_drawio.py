...
def test_full(render):
    ...
    c4.edge['label--0.2/12'](ext_host.r, portal.l[2]['circle'], 'Checks registration', 'cli, HTTP')
    c4.edge['label-0.2'](ext_user.t, portal.l['async'], 'Creates registration keys', 'Browser')
