...
def test_full(render):
    ...
    c4.edge['label--0.2/12 end-port-1'](ext_host.r, portal.l, 'Checks registration', 'cli, HTTP')
    c4.edge['label-0.2 end-port-0.1'](ext_user.t, portal.l, 'Creates registration keys', 'Browser')
